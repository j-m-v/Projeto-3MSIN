<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="to.MatriculaInformaticaTO" %>
        ...
        <head>
            ...
            <title>Consultar Matricula Informatica</title>
            ...
            <%MatriculaInformaticaTO to=( MatriculaInformaticaTO)request.getAttribute( "matriculaInformatica"); %>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="modalLabel">Excluir Matricula Informatica</h4>
                            </div>
                ...
                <div id="main" class="container">
                    ...
                    <div id="actions" class="row">
                        <div class="col-md-12">
                            <a href="ManterMatriculaInformatica.do?acao=Editar&id=<%=to.getCodigoMatricula()%>" class="btn btn-primary">Editar</a>
                            <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete-modal">Excluir</a>
                            <a href="Listar_MatriculaInformatica.html" class="btn btn-default">Voltar</a>
                        </div>
                    </div>
                </div>
