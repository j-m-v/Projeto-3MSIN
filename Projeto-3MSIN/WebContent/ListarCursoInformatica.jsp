							...
							<tbody>
								<c:forEach var="cursoInformatica"
									...
									<tr>
										...
										<td>${cursoInformatica.software}</td>
										<td>${cursoInformatica.numeroLaboratorios}</td>
										<td class="actions"><a class="btn btn-success btn-xs"
											href="ManterCursoInformatica.do?acao=Visualizar&id=${cursoInformatica.id}">Visualizar</a>
											<a class="btn btn-warning btn-xs"
											href="ManterCursoInformatica.do?acao=Editar&id=${cursoInformatica.id}">Editar</a>
