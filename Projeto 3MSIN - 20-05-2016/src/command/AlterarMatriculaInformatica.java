...
public class AlterarMatriculaInformatica implements Command {
	...
	public void executa(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<MatriculaInformaticaTO> lista = (ArrayList<MatriculaInformaticaTO>) session
				.getAttribute("lista");
		int pos = busca(MatriculaInformatica, lista);
		lista.remove(pos);
		lista.add(pos, MatriculaInformatica.getTO());
	...
	public int busca(MatriculaInformatica cliente, ArrayList<MatriculaInformaticaTO> lista) {
