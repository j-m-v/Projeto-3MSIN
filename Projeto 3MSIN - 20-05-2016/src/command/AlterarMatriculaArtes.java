...
public class AlterarMatriculaArtes implements Command {
	...
	public void executa(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<MatriculaArtesTO> lista = (ArrayList<MatriculaArtesTO>) session.getAttribute("lista");
		int pos = busca(matriculaArtes, lista);
		lista.remove(pos);
		lista.add(pos, matriculaArtes.getTO());
