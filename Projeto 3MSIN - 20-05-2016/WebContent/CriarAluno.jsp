				...
				<div class="row">
					<div class="form-group col-md-12">
						<label for="nome">Nome</label> <input type="text"
							...
							maxlength="100" pattern="[a-zA-Z áéíóúãõç§\s]+"
				...
				<div class="row">
					...
					<div class="form-group col-md-2">
						<label for="rg">RG</label> <input type="text" class="form-control"
							...
							required maxlength="12" pattern="\d{2}\.\d{3}\.\d{3}-\d{1}"
					...
					<div class="form-group col-md-3">
						<label for="dataNasc">Data de Nascimento</label> <input
							...
							onkeypress="mascara(this, '##/##/####')" required maxlength="10"
							pattern="[0-9]+[/]+[0-9]+[/]+[0-9]+$"
				...
				<div class="row">
					<div class="form-group col-md-3">
						<label for="telefone">Celular</label> <input type="tel"
							...
							maxlength="15" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}"
				...
				<div class="row">
					...
					<div class="form-group col-md-2">
						<label for="cep">CEP</label> <input type="text"
							...
							onkeypress="mascara(this, '#####-##')" required maxlength="8"
				...
				<div class="row">
					<div class="form-group col-md-4">
						<label for="cidade">Cidade</label> <input type="text"
							...
							maxlength="60" pattern="[a-zA-Z áéíóúãõç§\s]+"
