	...
	<div id="main" class="container-fluid">
		<form action="controller.do" method="post">
			<div id="top" class="row">
				...
				<div class="col-md-3">
					<a href="CriarCursoArtes.jsp" class="btn btn-primary pull-right h2">Novo
						Curso</a>
				</div>
			</div>
			<!-- /#top -->
				...
				<div class="table-responsive col-md-12">
					<div class="table-responsive col-md-12">
						<table class="table table-striped" cellspacing="0" cellpadding="0">
							...
							<tbody>
								<c:forEach var="cursoArtes" items="${lista}">
									<tr>
										<td>${cursoArtes.id}</td>
										...
										<td>${cursoArtes.livros}</td>
										<td>${cursoArtes.descricaoMaterial}</td>
										<td class="actions"><a class="btn btn-success btn-xs"
											href="controller.do?command=VisualizarCursoArtes&id=${cursoArtes.id}">Visualizar</a>
											<a class="btn btn-warning btn-xs"
											href="controller.do?command=EditarCursoArtes&id=${cursoArtes.id}">Editar</a>
