				...
				<div class="row">
					<div class="form-group col-md-12">
						<label for="nome">Nome</label> <input type="text"
							...
							maxlength="100" pattern="[a-zA-Záéíóúç\s]+"
							placeholder="nome completo" value="${aluno.nome}">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-2">
						<label for="cpf">CPF</label> <input type="text"
							...
							placeholder="Ex:000.000.000-00" value="${aluno.cpf}">
					</div>
					...
					<div class="form-group col-md-2">
						<label for="rg">RG</label> <input type="text" class="form-control"
							...
							placeholder="Ex: 11.111.111-1" value="${aluno.rg}">
					</div>
					<div class="form-group col-md-2">
						<label for="dataNasc">Data de Nascimento</label> <input
							...
							pattern="[0-9]+[/]+[0-9]+[/]+[0-9]+$"
							placeholder="Ex: 11/11/1111" value="${aluno.dataNascimento}">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-3">
						<label for="telefone">Celular</label> <input type="tel"
							...
							placeholder="Ex: (99) 99999-9999" value="${aluno.telefone}">
					</div>
				...
				<div class="row">
					<div class="form-group col-md-4">
						<label for="cidade">Cidade</label> <input type="text"
							...
							placeholder="Informe a cidade" value="${aluno.cidade}">
					</div>
					<div class="form-group col-md-2">
